...
public class ButtonAnimatorController : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerEnterHandler, IPointerExitHandler
{
    [Header("Scale & Duration")]
    
    /*-------------- CHANGED FROM HOLD TO HOVER  --------------- 
    ...
    [SerializeField] private Ease _exitEase = Ease.OutElastic;
    ...
    private void Awake()
    {
        ...
        */
        ...
        if (underline != null)
        {
            underline.alpha = 0f;                               // Hide underline initially
        }
    }
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        _scaleTween = transform.DOScale(_initialScale * _hoverScale, _hoverDuration)
            .SetEase(_hoverEase)
            .SetUpdate(true); 
        ...
        if (underline != null)
        {
            ...
            _underlineTween = DOTween.To(() => underline.alpha, x => underline.alpha = x, 1f, underlineFadeDuration);
        }
    }
    ...
    public void OnPointerExit(PointerEventData eventData)
    {
        ...
        _scaleTween = transform.DOScale(_initialScale * _normalScale, _exitDuration)
            .SetEase(_exitEase)
            .SetUpdate(true);
        ...
        {
            _underlineTween?.Kill();
            _underlineTween = DOTween.To(() => underline.alpha, x => underline.alpha = x, 0f, underlineFadeDuration);
        }
    }

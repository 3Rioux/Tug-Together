...
//     version 1.14.0
//     from Assets/Input/BoatInput_Actions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Input/BoatInput_Actions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @BoatInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""BoostLeft"",
                    ""type"": ""Button"",
                    ""id"": ""4a456690-841b-4431-bc8e-9a0842502593"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""BoostNormal"",
                    ""type"": ""Button"",
                    ""id"": ""833dda85-b89d-428c-ac3b-1899378d51db"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""336abfb5-b741-4fd7-a202-ee34ea3c36d1"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""a05934e3-8bf2-45d7-a95e-e23c21e9179c"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""bfc4e168-24e8-4679-8b07-f8f8921840fd"",
                    ""path"": ""<Keyboard>/r"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
    ...
    ""controlSchemes"": [
        ...
        m_Boat_Crouch = m_Boat.FindAction("Crouch", throwIfNotFound: true);
        m_Boat_Jump = m_Boat.FindAction("Jump", throwIfNotFound: true);
        m_Boat_Previous = m_Boat.FindAction("Previous", throwIfNotFound: true);
    ...
    private readonly InputAction m_Boat_Crouch;
    private readonly InputAction m_Boat_Jump;
    private readonly InputAction m_Boat_Previous;
    ...
    public struct BoatActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Boat/Attack".
        /// </summary>
        public InputAction @Attack => m_Wrapper.m_Boat_Attack;
        /// <summary>
        /// Provides access to the underlying input action "Boat/Interact".
        /// </summary>
        public InputAction @Interact => m_Wrapper.m_Boat_Interact;
        /// <summary>
        /// Provides access to the underlying input action "Boat/Crouch".
        /// </summary>
        public InputAction @Crouch => m_Wrapper.m_Boat_Crouch;
        /// <summary>
        /// Provides access to the underlying input action "Boat/Jump".
        /// </summary>
        public InputAction @Jump => m_Wrapper.m_Boat_Jump;
        /// <summary>
        /// Provides access to the underlying input action "Boat/Previous".
        /// </summary>
        public InputAction @Previous => m_Wrapper.m_Boat_Previous;
        /// <summary>
        /// Provides access to the underlying input action "Boat/Next".
        /// </summary>
        public InputAction @Next => m_Wrapper.m_Boat_Next;
        /// <summary>
        /// Provides access to the underlying input action "Boat/Sprint".
        /// </summary>
        public InputAction @Sprint => m_Wrapper.m_Boat_Sprint;
        /// <summary>
        ...
        /// </summary>
        public InputAction @BoostLeft => m_Wrapper.m_Boat_BoostLeft;
        /// <summary>
        /// Provides access to the underlying input action "Boat/BoostNormal".
        /// </summary>
        public InputAction @BoostNormal => m_Wrapper.m_Boat_BoostNormal;
        /// <summary>
        ...
        public void AddCallbacks(IBoatActions instance)
        {
            ...
            @BoostNormal.started += instance.OnBoostNormal;
            @BoostNormal.performed += instance.OnBoostNormal;
            @BoostNormal.canceled += instance.OnBoostNormal;
    ...
    public interface IBoatActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "BoostNormal" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnBoostNormal(InputAction.CallbackContext context);
        /// <summary>
